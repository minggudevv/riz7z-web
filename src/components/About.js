  ...
  const features = [
    {
      ...
      title: t('features.fastSecure.title'),
      description: t('features.fastSecure.description')
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: t('features.communityDriven.title'),
      description: t('features.communityDriven.description')
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: t('features.longTermVision.title'),
      description: t('features.longTermVision.description')
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: t('features.priceStability.title'),
      description: t('features.priceStability.description')
    }
  ];
    ...
    <section id="about" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.div
            variants={itemVariants}
            className="mt-6 inline-flex items-center px-6 py-3 bg-gradient-to-r from-r7z-blue/20 to-r7z-red/20 rounded-xl border border-r7z-blue/30"
          >
            <span className="text-r7z-blue font-semibold text-lg">
              {t('tokenSymbol')}: <span className="text-white">R7Z</span>
            </span>
          </motion.div>
        </motion.div>
